function main(){
  ...
  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setRectangleVertices(gl,-0.05,-0.9,0.1,0.9);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
  ...
  n=30;
  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setCircleVertices(gl,n,0.22, 0.2, 0.3);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
  ...
  n=30;
  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setCircleVertices(gl,n,0.22, -0.18, 0.3);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
  setCircleColor(gl,n,[1,0.2,0]);
  gl.drawArrays(gl.TRIANGLES, 0, 3*n); 

  n=30;
  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setCircleVertices(gl,n,0.22, -0.3, -0.1);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
  setCircleColor(gl,n,[1,0.2,0.1]);
  gl.drawArrays(gl.TRIANGLES, 0, 3*n); 

  n=30;
  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setCircleVertices(gl,n,0.22, -0.0, -0.35);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
  setCircleColor(gl,n,[1,0.2,0.2]);
  gl.drawArrays(gl.TRIANGLES, 0, 3*n); 
