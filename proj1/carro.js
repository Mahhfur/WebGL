function main(){
  ...
  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setRectangleVertices(gl,-0.5,-0.5,0.9,0.5);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
  setRectangleColor(gl,[1,0,0.1]);
  gl.drawArrays(gl.TRIANGLES, 0, 6);

  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setRectangleVertices(gl,-0.5,0.0,0.55,0.4);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
  setRectangleColor(gl,[1,0,0.4]);
  gl.drawArrays(gl.TRIANGLES, 0, 6);

  n=30;
  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setCircleVertices(gl,n,0.2, -0.3, -0.5);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
  ...
  n=30;
  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setCircleVertices(gl,n,0.12, -0.3, -0.5);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
  ...
  n=30;
  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setCircleVertices(gl,n,0.2, 0.2, -0.5);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
  setCircleColor(gl,n,[0.5, 0.5, 0.5]);
  gl.drawArrays(gl.TRIANGLES, 0, 3*n); 
  ...
  n=30;
  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setCircleVertices(gl,n,0.12, 0.2, -0.5);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
  setCircleColor(gl,n,[0,0,0]);
  gl.drawArrays(gl.TRIANGLES, 0, 3*n); 
...
/*
  n=30;
  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setCircleVertices(gl,n,0.09, 0.15, 0.2);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
  setCircleColor(gl,n,[0,0,0]);
  gl.drawArrays(gl.TRIANGLES, 0, 3*n); 
  ...
  n=30;
  gl.bindBuffer(gl.ARRAY_BUFFER,positionBuffer);
  setCircleVertices(gl,n,0.09, 0.0, 0.02);
  gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
...
function setRectangleVertices(gl, x, y, width, height) {
  ...
  function setCircleVertices(gl, n, radius, centerX, centerY) {
    let center = [centerX, centerY]; // Define o centro personalizado do círculo
    let vertexData = [];
